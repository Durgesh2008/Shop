  ...
  const RateArr=[1,1,1,1,1].fill(0,Rating,5)
    const FetchProductData=async ()=>{
       try {
        ...
        setRating(resData.rating.rate);
       } catch (error) {
          console.log('error is fetching data in Product page ')
       }
    }
...
<section className="text-gray-700 body-font overflow-hidden bg-white">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-[33%] p-5 w-full object-cover object-center rounded border border-gray-200" src={ProductData.image}/>
